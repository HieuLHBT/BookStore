...
class CartsController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        if let book = Book(book_id: 1, book_name: "Sách một", author: "Tác giả một", price: 80000, image: UIImage(named: "Image1"), quantity: 2, total_money: 80000) {
            books += [book]
        }
        if let book = Book(book_id: 2, book_name: "Sách hai", author: "Tác giả hai", price: 120000, image: UIImage(named: "Image2"), quantity: 1, total_money: 240000) {
            books += [book]
        }
